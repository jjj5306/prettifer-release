...
1. **Open Repository** — 검토할 로컬 Git 저장소를 엽니다.
...
| 충돌 파일 | 계산을 실패로 표시하고 필요한 선행 커밋을 안내합니다 |
...
배포본에는 프로젝트 자동 검증용 환경 경계가 포함되어 있습니다. 기본 실행에서는
비활성이며 `PRETTIFER_E2E=1`을 명시한 환경에서만 동작합니다.
